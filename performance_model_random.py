...
class AllocationFramework:
    ...
    def __assign_failure(self):

        failure_allocated_to = random.randint(0, self.NUM_OPERATORS-1)
    ...
    def main_loop(self):
        ...
        for i in range(self.NUM_FAILURES):
            ...
            assigned_to = self.__assign_failure()
...
class DataRecorder:
    ...
    def save_results(self, failure_id, assigned_to, start_time, duration, threshold, task_requirements, failures_assigned, operator_time_failures):
    ...
    def write_results(self):
        ...
        base_filename = f'random_{self.NUM_OPERATORS}_operators_{self.NUM_FAILURES}_failures.csv'
